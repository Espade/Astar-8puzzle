...
var treeSVG = {
    ...
    initSVG: function () {
        ...
        treeSVG.tool_tip = d3.tip()
            ...
            .html(function (d) {
                ...
                var arr = Array.from(d.data.array);
                arr.splice(0, 0, '');
                arr.splice(4, 0, '<br>');
                arr.splice(8, 0, '<br>');
    ...
    update: function () {
        ...
        if (treeSVG.toggleUpdate) {
            ...
            var expand = treeSVG.process.shift();
            ...
            var parent = treeSVG.data[expand.parent];
            parent.children = [];
            ...
            var nodes = treeSVG.tree(treeSVG.root);

            // Update the nodes…
            var node = treeSVG.vis.selectAll(".node")
            ...
            // Update the links…
            var link = treeSVG.vis.selectAll("path.link")
